<template>
    <div class="w-full z-40  shadow-lg">
        <div class="max-w-screen-2xl px-3 md:px-7 py-3 md:py-9 bg-slate-100 border-gray-400 h-16 mx-auto flex items-center justify-between">
            
            <nuxt-link to='/'> <HeaderLogo class="drop-shadow-sm pl-2" /> </nuxt-link>
            
            <div>
                <ul class="flex space-x-2 items-center">
                    <li class="hidden py-1.5 px-2.5 rounded-lg md:block text-slate-800 lgtoxl hover:text-slate-400 transition hover:duration-300 font-normal">
