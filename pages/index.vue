        ...
        <div data-aos="fade-up" class=" grid pt-8 text-left border-t border-gray-200 md:gap-16 dark:border-gray-700 md:grid-cols-2">
            <div>
                <div class="mb-10">
                    ...
                    <p class="text-slate-400"><a class="underline" href="https://zeropage.org/">메인 사이트</a>
                ...
                <div class="mb-10">                        
                    ...
                    <p class="text-slate-400">스터디마다 스터디원들에게 요구하는 최소 수준이 있긴 하지만, 다양한 스터디가 존재하니 괜찮습니다. 처음부터 잘하는 사람은 없으니까요.
                ...
                <div class="mb-10">
                    ...
                    <p class="text-slate-400">학년에 무관하게 프로그래밍에 관심이 있는 누구든 모두 제로페이지에 가입가능합니다!</p>
                </div>
            ...
            <div>
              <div class="mb-10">
                    ...
                    <p class="text-slate-400">제로페이지에서는 매주 수요일마다 정기 모임을 가집니다. 정기 모임에서는 동아리 주요 행사들(데블스캠프, 새싹교실 등)에 대한 공지, 진행상황 보고를 하고 OMS도 같이 진행합니다.
                ...
                <div class="mb-10">
                    ...
                    <p class="text-slate-400">아닙니다! 본인의 스케줄에 맞게 원하는 행사만 골라서 참여하실 수 있습니다!</p>
                </div>
                <div class="mb-10">
                    <h3 class="flex items-center mb-4 text-lg font-medium text-white">
                        <svg class="flex-shrink-0 mr-2 w-5 h-5 text-gray-500 dark:text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-8-3a1 1 0 00-.867.5 1 1 0 11-1.731-1A3 3 0 0113 8a3.001 3.001 0 01-2 2.83V11a1 1 0 11-2 0v-1a1 1 0 011-1 1 1 0 100-2zm0 8a1 1 0 100-2 1 1 0 000 2z" clip-rule="evenodd"></path></svg>
                    ...
                    <p class="text-slate-400">없습니다! 감사하게도 졸업하신 선배님들이 '지피지기'라는 이름으로 필요할 때마다 자금을 지원해주신 덕에 무리 없이 유익한 행사들을 진행할 수 있습니다.</p>
                </div>
